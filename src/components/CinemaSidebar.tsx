...
export function CinemaSidebar({ theme, toggleTheme }: { 
  ...
  return (
    <aside
      className="hidden lg:flex flex-col transition-all duration-300 ease-in-out w-80 flex-shrink-0"
      style={{ minWidth: 320 }}
    >
      <div
        className="glass-sidebar p-6 h-[100vh] rounded-r-2xl flex flex-col sticky top-0 shadow-[4px_0_32px_-8px_rgba(185,255,0,0.10)] border-r border-cinema-card/30"
        style={{
          backdropFilter: 'blur(24px)',
          WebkitBackdropFilter: 'blur(24px)',
          boxShadow: '4px 0 32px -8px rgba(185,255,0,0.10)',
        }}
      >
        {/* Header with Logo */}
